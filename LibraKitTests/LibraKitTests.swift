...
class LibraSDKTests: XCTestCase {
    ...
    func testULEB128() {
        ...
        print(LibraUtils.uleb128FormatToInt(data: LibraUtils.uleb128Format(length: 16384)))
        
        XCTAssertEqual(LibraUtils.uleb128FormatToInt(data: LibraUtils.uleb128Format(length: 128)), 128)
        XCTAssertEqual(LibraUtils.uleb128FormatToInt(data: LibraUtils.uleb128Format(length: 16384)), 16384)
        XCTAssertEqual(LibraUtils.uleb128FormatToInt(data: LibraUtils.uleb128Format(length: 2097152)), 2097152)
        XCTAssertEqual(LibraUtils.uleb128FormatToInt(data: LibraUtils.uleb128Format(length: 268435456)), 268435456)
        XCTAssertEqual(LibraUtils.uleb128FormatToInt(data: LibraUtils.uleb128Format(length: 9487)), 9487)
    }
    func testBitmap() {
